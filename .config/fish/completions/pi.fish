...
complete -c pi -l provider -x -a 'anthropic openai azure-openai google vertex deepseek nvidia groq cerebras xai openrouter deepinfra bedrock mistral fireworks together baseten kimi minimax moonshot opencode cloudflare vercel zai github-copilot' -d 'Model provider'
